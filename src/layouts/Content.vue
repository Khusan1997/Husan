        ...
        <div class="d-flex align-center mx-6">
          ...
          <!-- <v-menu offset-y >
            <template v-slot:activator="{ attrs, on }">
              <v-btn style="background-color: #c48eff; border-radius:20px " class=" ma-5" v-bind="attrs" v-on="on">{{$t('uz')}} </v-btn>
            </template>

            <v-list>
              <v-list-item @click="changeLanguage('uz_latn')" link>
                <v-list-item-title >O'zbek tili</v-list-item-title>
              </v-list-item>
              <v-list-item @click="changeLanguage('uz_cyrl')" link>
                <v-list-item-title>Ўзбек тили</v-list-item-title>
              </v-list-item>
              <v-list-item  @click="changeLanguage('ru')" link>
