  ...
  >
    ...
    <div class="vertical-nav-header d-flex items-center ps-6 pe-5 pt-5 pb-2">
      ...
      >
        ...
        <v-slide-x-transition>
          <h6 style="font-size:13px !important; text-transform:uppercase" class="text--primary">
            Sport va Turizm vazirligi
          </h6>
        </v-slide-x-transition>
      </router-link>
    </div>
    ...
    >
      ...
      >
        ...
        ></nav-menu-link>
          <nav-menu-link
          title="StudentGradeMovement"
          :to="{ name: 'studentgrademovement' }"
        ></nav-menu-link>
          <nav-menu-link
          title="LeavingStudentReStudyClass"
          :to="{ name: 'leavingstudentrestudyclass' }"
        ></nav-menu-link>
         <nav-menu-link
